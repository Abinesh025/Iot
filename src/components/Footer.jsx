        ...
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96 text-center md:text-left">
                    ...
                    <p className="mt-6 text-xl text-black font-bold">
                        E.G.S PILLAY ENGINEERING COLLEGE
                    </p>
                    <span className='text-sm'>AN Autonomous Institution | Affiliated to Anna University </span>
                    <span className='text-sm'>Accredited by NBA & NAAC with Grade 'A++'</span>
                </div>
                <div className="flex-1 flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-start md:justify-end gap-8 sm:gap-10 md:gap-16 lg:gap-20 text-center sm:text-left">
                    <div className="w-full sm:w-auto">
                        <h2 className="font-semibold mb-5 text-gray-800">Components</h2>
                        <ul className="text-sm space-y-2">
                            <li><a href="/tutorial/arduino">Ardino</a></li>
                            <li><a href="/tutorial/raspberry-pi">Rasperry Pi</a></li>
                            <li><a href="/tutorial/esp32">ESP 32</a></li>
                        </ul>
                    </div>
                    <div className="w-full sm:w-auto">
                        <h2 className="font-semibold mb-5 text-gray-800">Social Links</h2>
                        <ul className="text-sm space-y-2">
                    ...
                    <div className="w-full sm:w-auto">
                        ...
                        <div className="text-sm space-y-2">
                             <a href="callto:8680954537"><i class="fa-thin fa-phone"></i> 7373 067 032 | 8680 954 537 </a><br></br>
                            <a href='mailto:principle@egspec.org'>
                                principal@egspec.org
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <p className="pt-4 text-center text-xs md:text-sm pb-5">
                Copyright © 2006 - 2026 All Rights Reserved by  <a href="https://prebuiltui.com">EGS Pillay Group of Institutions</a>.
            </p>
        </footer>
    );
};
